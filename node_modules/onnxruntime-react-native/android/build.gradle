...
dependencies {
  ...
  implementation "com.microsoft.onnxruntime:onnxruntime-android:1.20.0@aar"

  // By default it will just include onnxruntime full aar package
  if (ortExtensionsEnabled) {
    implementation "com.microsoft.onnxruntime:onnxruntime-extensions-android:0.13.0@aar"
  }
}